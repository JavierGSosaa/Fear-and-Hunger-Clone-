// Peek.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    Player* Testname=new Player ("Leguard", 100, 10);
    //set an in here 
    Item* scroll= new Item ("nothing",0);//it works 
    ...
    delete scroll;//this is an issue now 
    delete Testname;//both do the fuck
